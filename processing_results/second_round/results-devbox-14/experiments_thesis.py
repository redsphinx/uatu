...
def ex_25_0():
    ...
    a.use_gpu = '1'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 25_0: test=viper, train=[grid, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'viper'
    a.ranking_number_test = 100
    a.datasets_train = ['grid', 'prid450', 'cuhk02', 'market']
    a.ranking_number_train = [5, 5, 5, 5]
    a.neural_distance = 'concatenate'
...
def ex_25_1():
    ...
    a.use_gpu = '1'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 25_1: test=grid, train=viper, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'grid'
    a.ranking_number_test = 100
    a.datasets_train = ['viper', 'prid450', 'cuhk02', 'market']
    a.ranking_number_train = [5, 5, 5, 5]
    a.neural_distance = 'concatenate'
    a.upper_bound_pos_pairs_per_id = 3
    a.mix = True
...
def ex_25_2():
    ...
    a.use_gpu = '1'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 25_2: test=prid450, train=viper, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'prid450'
    a.ranking_number_test = 100
    a.datasets_train = ['grid', 'viper', 'cuhk02', 'market']
    a.ranking_number_train = [5, 5, 5, 5]
    a.neural_distance = 'concatenate'
    a.upper_bound_pos_pairs_per_id = 3
    a.mix = True
...
def ex_26_0():
    ...
    a.use_gpu = '2'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_0: [benchmark] test=viper, train=[grid, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'viper'
    a.ranking_number_test = 316
...
def ex_26_1():
    ...
    a.use_gpu = '2'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_1: [benchmark] test=grid, train=viper, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'grid'
...
def ex_26_2():
    ...
    a.use_gpu = '2'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_2: [benchmark] test=prid450, train=viper, prid450, cuhk02, market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'prid450'
...
def ex_26_3():
    ...
    a.use_gpu = '2'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_3: [benchmark] test=market, train=viper, prid450, cuhk02, grid'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'market'
...
def ex_26_4():
    ...
    a.use_gpu = '2'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_4: [benchmark] test=cuhk02, train=viper, prid450, market, grid'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'cuhk02'
    a.ranking_number_test = 'half'
    a.datasets_train = ['grid', 'viper', 'market', 'prid450']
    a.ranking_number_train = [5, 5, 5, 5]
    a.neural_distance = 'concatenate'
    a.upper_bound_pos_pairs_per_id = 3
    a.mix = True
...
# augmenting small datasets for benchmark absolute vs. concatenate
# effect of augmenting the small datasets viper, grid, prid450
def ex_28_0_0():
    a = ProjectVariable()
    a.experiment_name = 'experiment 28_0_0: [benchmark] viper_augmented, neural_distance=concatenate'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_28_0_1():
    a = ProjectVariable()
    a.experiment_name = 'experiment 28_0_1: [benchmark] prid450_augmented, neural_distance=concatenate'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_28_0_2():
    a = ProjectVariable()
    a.experiment_name = 'experiment 28_0_2: [benchmark] grid_augmented, neural_distance=concatenate'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_29_0_0():
    a = ProjectVariable()
    a.experiment_name = 'experiment 29_0_0: [benchmark] viper_augmented, neural_distance=absolute'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_29_0_1():
    a = ProjectVariable()
    a.experiment_name = 'experiment 29_0_1: [benchmark] prid450_augmented, neural_distance=absolute'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_29_0_2():
    a = ProjectVariable()
    a.experiment_name = 'experiment 29_0_2: [benchmark] grid_augmented, neural_distance=absolute'
    a.use_gpu = '0'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 20
...
def ex_30_0():
    ...
    for itera in range(iterations):
        ...
        a.save_inbetween = True
        a.save_points = [100]
        a.name_of_saved_file = 'grid_augmented'
        ...
        a.load_weights_name = 'grid_augmented_epoch_100'
        a.test_only = True
        a.dataset_test = 'cuhk02'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_0: train on grid_augmented and then test on cuhk02'
...
def ex_30_1():
    ...
    for itera in range(iterations):
        ...
        a.load_weights_name = 'cuhk02_epoch_100'
        a.test_only = True
        a.dataset_test = 'grid'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_1: train on cuhk02 and then test on grid_augmented'
...
# benchmark cuhk02 and market on their on training dataset
def ex_26_5():
    a = ProjectVariable()
    a.use_gpu = '3'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_5: [benchmark] test=market'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'market'
    a.ranking_number_test = 'half'
...
def ex_26_6():
    ...
    a.use_gpu = '3'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 26_6: [benchmark] test=cuhk02'
    a.epochs = 100
    a.iterations = 20
    a.dataset_test = 'cuhk02'
    a.ranking_number_test = 'half'
...
def ex_30_2():
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_2: train on cuhk02 then test only on market'
...
def ex_30_3():
    ...
    for itera in range(iterations):
        ...
        a.load_weights_name = 'market_epoch_100'
        a.test_only = True
        a.dataset_test = 'cuhk02'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_3: train on market then test only on cuhk02'
...
def ex_30_4():
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_4: train on market then test only on grid'
...
def ex_30_5():
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_5: train on grid_augmented then test only on market'
...
def ex_30_6():
    ...
    for itera in range(iterations):
        ...
        a.datasets_train = ['cuhk02', 'market']
        a.mix = True

        a.save_inbetween = True
        a.save_points = [100]
        a.name_of_saved_file = 'c_m'
        ...
        a.load_weights_name = 'c_m_epoch_100'
        a.test_only = True
        a.dataset_test = 'grid'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_6: train on cuhk02,market then test only on grid'
...
def ex_30_7():
    ...
    for itera in range(iterations):
        ...
        a.datasets_train = ['cuhk02', 'grid_augmented']
        a.mix = True

        a.save_inbetween = True
        a.save_points = [100]
        a.name_of_saved_file = 'c_g'
        ...
        a.load_weights_name = 'c_g_epoch_100'
        a.test_only = True
        a.dataset_test = 'market'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_7: train on cuhk02,grid_aug then test only on market'
...
def ex_30_8():
    ...
    for itera in range(iterations):
        ...
        a.datasets_train = ['market', 'grid_augmented']
        a.mix = True

        a.save_inbetween = True
        a.save_points = [100]
        a.name_of_saved_file = 'm_g'
        ...
        a.load_weights_name = 'm_g_epoch_100'
        a.test_only = True
        a.dataset_test = 'cuhk02'
        a.ranking_number_test = 100
        a.log_experiment = False
    ...
    a.use_gpu = the_gpu
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.experiment_name = 'experiment 30_8: train on market,grid_aug then test only on cuhk02'
...
def ex_32_0():
    a = ProjectVariable()
    a.experiment_name = 'experiment 32_0: benchmark market, cost_module_type=euclidean, lr=0.00001'
    a.use_gpu = '1'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 10
...
def ex_32_1():
    a = ProjectVariable()
    a.experiment_name = 'experiment 32_1: benchmark cuhk02, cost_module_type=euclidean, lr=0.00001'
    a.use_gpu = '1'
    a.log_file = 'thesis_results_%s.txt' % a.use_gpu
    a.epochs = 100
    a.iterations = 10
...
def main():
    ...
    if num == '27_2': ex_27_2()
    if num == '27_3': ex_27_3()
    if num == '28_0_0': ex_28_0_0()
    if num == '28_0_1': ex_28_0_1()
    if num == '28_0_2': ex_28_0_2()
